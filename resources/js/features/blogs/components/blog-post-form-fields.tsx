    ...
    return (
        <div className="space-y-4">
            <div>
                ...
                <input
                    ...
                    onChange={(e) =>
                        form.setData(
                            'title',
                            e.currentTarget.value as TForm['title'],
                        )
                    }
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) =>
                        form.setData(
                            'slug',
                            e.currentTarget.value as TForm['slug'],
                        )
                    }
                    className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm transition outline-none focus:border-primary focus:ring-2 focus:ring-ring/20"
                />
            ...
            <div>
                ...
                <Select
                    ...
                    onValueChange={(value) =>
                        form.setData(
                            'status',
                            value as BlogPostStatus as TForm['status'],
                        )
                    }
                >
            ...
            <BlogPostCoverInput
                ...
                onChange={(file) =>
                    form.setData('cover_image', file as TForm['cover_image'])
                }
            ...
            <div>
                ...
                <BlogPostEditor
                    ...
                    onChange={(value) =>
                        form.setData('content', value as TForm['content'])
                    }
