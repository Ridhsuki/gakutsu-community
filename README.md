...
**This application is under active development and is not production-ready.**

The current phase is **P0: Project Recovery and Stabilization**. See [docs/ROADMAP.md](docs/ROADMAP.md) for the full plan.
...
| Member | Registers for events, takes quizzes, views scores            |
...
tests/
├── Feature/          # Auth, Dashboard, Settings tests
└── Unit/             # Unit tests
